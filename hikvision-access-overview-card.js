 ...
 * Kompakte Mehrfach-Übersicht mehrerer Face-Terminals (eine Karte pro Gebäude/Tab).
 *
 * Eigene Lovelace-Ressource (zusätzlich zur hikvision-access-card.js):
 *   /hacsfiles/<repo>/hikvision-access-overview-card.js  · Typ: JavaScript-Modul
 */
...
window.customCards.push({
  type: "hikvision-access-overview-card",
